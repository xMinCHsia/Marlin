...
Plans are deterministic given inputs: steps sorted by draft id, hash
over the ordered payload. This makes A/B tests of ensemble changes
honest - you compare hashes, not vibes.
